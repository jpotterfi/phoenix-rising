        ...
        box.addEventListener("drop", function () {
          ...
          if (
            ...
            if (getIsAllPlaced()) {
              ...
              commander.innerText = "Commander (A.I will fire randomly)";
              ...
              admiral.innerText = "Fleet Admiral (A.I will hunt ships on hit)";
              admiral.id = "admiral";
              ...
              harbor.appendChild(commander);
              harbor.appendChild(admiral);
